#ifndef UDP_HAND_API_H_right
#define UDP_HAND_API_H_right
...
namespace right_hand_api
{
    ...
    private:
        ...
        int sockfd;
        UDPData_right UDP_Data;

    public:
        DeviceState HandState = NONE;
        std::thread readdata;
    ...
    public:
        ...
        int Hand_Get(uint8_t ID, double time_g);
